...
table<Programme> key(programmeCode) programmeTable = table[
    {
        programmeCode: "08BEME",
        nqfLevel: 6,
        faculty: "Engineering and the Built Environment",
        department: "Mechanical Engineering",
        title: "BEng Mechanical Engineering",
        registrationDate: "2022-07-15T00:30:00Z",
        courses: [
            {courseCode: "ME201", courseName: "Fluid Mechanics", nqfLevel: 5},
            {courseCode: "ME202", courseName: "Thermodynamics", nqfLevel: 6}
        ]
    },
    {
        programmeCode: "07BBMA",
        nqfLevel: 7,
        faculty: "Commerce, Human Sciences, and Education",
        department: "Business Management",
        title: "BBA Business Management",
        registrationDate: "2018-05-01T00:30:00Z",
        courses: [
            {courseCode: "BM301", courseName: "Organizational Behavior", nqfLevel: 6},
            {courseCode: "BM302", courseName: "Strategic Management", nqfLevel: 7}
        ]
    }
];

// HTTP service to handle programme-related operations
service /programmes on new http:Listener(8081) {
    ...
    resource function get reiviewDueProgramme(http:Caller caller) returns error? {
        ...
        check caller->respond(dueProgramme);
    }
    ...
    resource function delete Programmes/[string programmeCode]() returns http:Response {
        ...
        if programmeTable.hasKey(programmeCode) {
            ...
            response.setPayload("Program successfully");
        } else {
