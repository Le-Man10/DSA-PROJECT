...
table<User> key(username) UserTable = table[
    {username: "alice_walker", email: "alice.walker@example.com", password: "alice123", user: Customer},
...
table<Products> key(sku) productTable = table[
    {name: "Tablet", description: "10-inch Android tablet", price: 3000.00, stock_quantity: 12, sku: "PROD005", status: Available},
